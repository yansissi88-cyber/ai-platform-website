      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
          ...
          >
            <Button
              size="lg"
              className="bg-gradient-to-r from-kr-blue-600 to-kr-cyan-500 hover:from-kr-blue-500 hover:to-kr-cyan-400 text-white shadow-glow hover:shadow-glow-lg transition-all duration-300 group text-base px-8"
            >
              Get Started
