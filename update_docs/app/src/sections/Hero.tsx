          ...
          <div className="text-center lg:text-left space-y-6 lg:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a href="#features">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-kr-blue-600 to-kr-cyan-500 hover:from-kr-blue-500 hover:to-kr-cyan-400 text-white shadow-glow hover:shadow-glow-lg transition-all duration-300 group w-full sm:w-auto"
                >
                  Explore Features
              ...
              >
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white/20 text-white hover:bg-white/5 group w-full sm:w-auto"
                >
