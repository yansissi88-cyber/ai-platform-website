        ...
        <nav className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              <Button className="bg-gradient-to-r from-kr-blue-600 to-kr-cyan-500 hover:from-kr-blue-500 hover:to-kr-cyan-400 text-white shadow-glow hover:shadow-glow-lg transition-all duration-300">
                Talk to Expert
              </Button>
            </a>
          </div>
        ...
        <div className="bg-kr-dark-900/95 backdrop-blur-xl border-t border-white/5 px-4 py-4 space-y-2">
          ...
          <div className="pt-4 space-y-2">
            ...
            <a
              ...
              className="block w-full"
            >
              <Button className="w-full bg-gradient-to-r from-kr-blue-600 to-kr-cyan-500">
                Talk to Expert
              </Button>
            </a>
          </div>
